...
const ProductDetails = () => {
  ...
  style={{ width: '100%', maxWidth: '1200px', margin: '550%' }}></BannerCard> */}
                ...
                <Typography
                  variant='h5'
                  onClick={() => setDraftingOpen(!draftingOpen)}
                  style={{ cursor: 'pointer', fontWeight: 'bold' }}
                >
                  Details
                  <ExpandMoreIcon
                    style={{
                      transform: draftingOpen
                        ? 'rotate(180deg)'
                        : 'rotate(0deg)'
                    }}
                  />
              ...
              {/* <DottedCard> */}
                    ...
                    >
                      <Button
                        variant='contained'
                        onClick={handleDraftingContinue}
                        style={{
                          marginTop: '1rem',
                          borderRadius: '100px',
                          boxShadow: 'none',
                ...
                {countriesOpen && (
                  <div style={{ padding: '1rem 0' }}>
                    ...
                    <Button
                      style={{
                        // 68BDFD
                        background: country.includes('United States')
                          ? 'linear-gradient(90deg, rgba(0, 172, 246, 0.8) 0%, rgba(2, 225, 185, 0.79) 91.25%)'
                          : '#F8FCFF',
                        color: country.includes('United States')
                          ? 'white'
                          : '#BFBFBF',
                        width: '18%',
                        boxShadow: 'none',
