...
const Filing = require("../models/patent_filing"); // Import Patent Filing Model
const Search = require("../models/search"); // Import Patent Search Model
const { renderJobNumbers } = require("../../order_number_generator");
const { PythonShell } = require('python-shell');
const responseToFER = require("../models/response_to_fer"); // Import Response to FER Model
const freedomToOperate = require("../models/freedom_to_operate"); // Import Freedom to Operate Model
const patentLandscape = require("../models/freedom_to_patent_landscape"); // Import Patent Landscape Model
const patentPortfolioAnalysis = require("../models/patent_portfolio_analysis"); // Import Patent Portfolio Analysis Model
const patentTranslation = require("../models/patent_translation_service"); // Import Patent Translation Services Model
...
const patentLicense = require("../models/patent_licensing"); // Import Patent Licensing Model
